    ...
    public void request() {
        try {
            HttpURLConnection con = (HttpURLConnection) (new URL(
                    "https://karmatop.de/addon/bugfixes.php?name=" + LabyMod.getInstance().getLabyModAPI().getPlayerUsername() + "&uuid=" + LabyMod.getInstance().getLabyModAPI().getPlayerUUID())).openConnection();
